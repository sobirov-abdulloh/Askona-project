        ...
        <div className="w-[1400px] m-auto flex items-center justify-between">
          <div className="">
            <p className="font-semibold text-sm">
              © 1990–2022. Компания «Аскона»
            </p>
            <p className="font-normal text-sm">
              В торг. реестре с 18.12.2019г., № 468759, УНП 193341168,
              Мингорисполком. ООО «ТД Аскона-Импорт»{" "}
            </p>
            <p className="font-normal text-sm">
              юр.адрес: 220089, город Минск, проспект Дзержинского, дом 57,
              помещение № 54-1, 14-й этаж.
            </p>
          </div>
